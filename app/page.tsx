    ...
    <main className="flex flex-col items-center justify-between min-h-screen p-24">
      ...
      <div className="relative flex items-center justify-center w-full h-full p-20 overflow-hidden border border-gray-800 rounded-lg bg-background">
        ...
        <div className="flex mt-4 text-sm leading-6 text-gray-600">
          <label
            htmlFor="file-upload"
            className="relative text-3xl font-semibold text-gray-100 rounded-md cursor-pointer focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2"
          >
